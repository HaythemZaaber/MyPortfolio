...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "haythemzaaber28@gmail.com",
    href: "mailto:haythemzaaber28@gmail.com",
  },
  {
    icon: Phone,
    label: "Phone",
    value: "+216 96 720 146",
    href: "tel:+21696720146",
  },
  {
    icon: MapPin,
    label: "Location",
    value: "Sousse, Tunisia",
    href: "https://maps.app.goo.gl/ykPqckGa4NjvoM1v5",
  },
];
...
const socialLinks = [
  ...
  {
    icon: Linkedin,
    href: "https://www.linkedin.com/in/haythem-zaaber/",
    label: "LinkedIn",
  },
